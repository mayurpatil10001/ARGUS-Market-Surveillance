...
export const mockAlerts = [
  {
    ...
    social_signal_score: 0.82, misinfo_score: 0.71, threat_type: 'market_manipulation',
    estimated_gain: 47500000,
    severity: 'high', recommended_action: 'freeze_accounts_pending_review',
    mitigation_status: 'pending', auto_mitigated: false, escalated_to_sebi: false,
    mitigation_notes: 'Score 8.90/10. GNN 7.0 + high social signal 0.82.',
  },
  {
    ...
    social_signal_score: 0.3, misinfo_score: 0.2, threat_type: 'market_manipulation',
    estimated_gain: 3200000,
    severity: 'high', recommended_action: 'freeze_accounts_pending_review',
    mitigation_status: 'pending', auto_mitigated: false, escalated_to_sebi: false,
    mitigation_notes: 'Score 8.50/10. DNA score 10.0 matches known spoofing fingerprint.',
  },
  {
    ...
    social_signal_score: 0.15, misinfo_score: 0.1, threat_type: 'market_manipulation',
    estimated_gain: 8750000,
    severity: 'medium', recommended_action: 'flag_accounts_for_investigation',
    mitigation_status: 'pending', auto_mitigated: false, escalated_to_sebi: false,
    mitigation_notes: 'Score 7.90/10. Cross-market 10.0 indicates circular ring.',
  },
  {
    ...
    social_signal_score: 0.45, misinfo_score: 0.3, threat_type: 'market_manipulation',
    estimated_gain: 125000000,
    severity: 'critical', recommended_action: 'freeze_accounts_and_escalate_sebi',
    mitigation_status: 'applied', auto_mitigated: false, escalated_to_sebi: true,
    mitigation_applied_by: 'sr_analyst', escalation_timestamp: hoursAgo(1),
    mitigation_notes: 'Score 9.20/10 CRITICAL. Escalated to SEBI enforcement.',
  },
  {
    ...
    social_signal_score: 0.91, misinfo_score: 0.88, threat_type: 'market_manipulation',
    estimated_gain: 22300000,
    severity: 'high', recommended_action: 'freeze_accounts_pending_review',
    mitigation_status: 'pending', auto_mitigated: false, escalated_to_sebi: false,
    mitigation_notes: 'Score 8.70/10. High social signal 0.91 + misinfo 0.88 detected.',
  },
  {
    ...
    social_signal_score: 0.2, misinfo_score: 0.15, threat_type: 'market_manipulation',
    estimated_gain: 9100000,
    severity: 'medium', recommended_action: 'flag_accounts_for_investigation',
    mitigation_status: 'dismissed', auto_mitigated: false, escalated_to_sebi: false,
    mitigation_notes: 'Dismissed: insufficient evidence for immediate freeze.',
  },
  {
    ...
    social_signal_score: 0.35, misinfo_score: 0.22, threat_type: 'market_manipulation',
    estimated_gain: 4500000,
    severity: 'medium', recommended_action: 'flag_accounts_for_investigation',
    mitigation_status: 'pending', auto_mitigated: false, escalated_to_sebi: false,
    mitigation_notes: 'Score 7.60/10. Spoofing pattern detected via DNA match.',
  },
  {
    id: 'a1b2c3d4-0008', scrip: 'DEVINFRA', exchange: 'NSE',
    detected_at: hoursAgo(11), impossibility_score: 7.5,
    scheme_type: 'zero_day_anomaly', status: 'open',
    accounts_involved: ['ZD_001','ZD_002','ZD_003','ZD_004'],
    gnn_score: 7.2, dna_score: 6.8, cross_market_score: 5.5, zero_day_score: 9.1,
    social_signal_score: 0.12, misinfo_score: 0.09, threat_type: 'market_manipulation',
    estimated_gain: 6800000,
    severity: 'medium', recommended_action: 'flag_accounts_for_investigation',
    mitigation_status: 'pending', auto_mitigated: false, escalated_to_sebi: false,
    mitigation_notes: 'Score 7.50/10. Zero-day 9.1 — novel pattern, monitoring.',
  },
  {
    ...
    social_signal_score: 0.55, misinfo_score: 0.4, threat_type: 'social_media_threat',
    estimated_gain: 3400000,
    severity: 'low', recommended_action: 'block_social_signals_and_alert_compliance',
    mitigation_status: 'applied', auto_mitigated: false, escalated_to_sebi: false,
    mitigation_notes: 'Social media pump campaign detected. Compliance notified.',
  },
  {
    ...
    social_signal_score: 0.1, misinfo_score: 0.08, threat_type: 'market_manipulation',
    estimated_gain: 5200000,
    severity: 'low', recommended_action: 'monitor_and_log',
    mitigation_status: 'applied', auto_mitigated: false, escalated_to_sebi: false,
    mitigation_notes: 'Below critical threshold. Monitoring and logging.',
  },
  {
    ...
    social_signal_score: 0.06, misinfo_score: 0.04, threat_type: 'market_manipulation',
    estimated_gain: 1200000,
    severity: 'low', recommended_action: 'monitor_and_log',
    mitigation_status: 'dismissed', auto_mitigated: false, escalated_to_sebi: false,
    mitigation_notes: 'Confirmed false positive by analyst review.',
  },
  {
    id: 'a1b2c3d4-0012', scrip: 'OILPIPE_LTD', exchange: 'BSE',
    detected_at: daysAgo(1), impossibility_score: 5.8,
    scheme_type: 'zero_day_anomaly', status: 'false_positive',
    accounts_involved: ['OPL_001','OPL_002','OPL_003'],
    gnn_score: 5.1, dna_score: 5.8, cross_market_score: 3.5, zero_day_score: 6.4,
    social_signal_score: 0.05, misinfo_score: 0.03, threat_type: 'generic_digital_threat',
    estimated_gain: 980000,
    severity: 'low', recommended_action: 'flag_entity_for_review',
    mitigation_status: 'dismissed', auto_mitigated: false, escalated_to_sebi: false,
    mitigation_notes: 'Flagged as false positive - digital anomaly, not manipulation.',
  },
  {
    ...
    social_signal_score: 0.77, misinfo_score: 0.65, threat_type: 'market_manipulation',
    estimated_gain: 31500000,
    severity: 'high', recommended_action: 'freeze_accounts_pending_review',
    mitigation_status: 'escalated', auto_mitigated: false, escalated_to_sebi: true,
    escalation_timestamp: daysAgo(1),
    mitigation_notes: 'Score 8.10/10. Case filed with SEBI.',
  },
  {
    ...
    social_signal_score: 0.6, misinfo_score: 0.5, threat_type: 'market_manipulation',
    estimated_gain: 210000000,
    severity: 'critical', recommended_action: 'freeze_accounts_and_escalate_sebi',
    mitigation_status: 'escalated', auto_mitigated: true, escalated_to_sebi: true,
    escalation_timestamp: daysAgo(2),
    mitigation_notes: 'Score 9.40/10 CRITICAL. AUTO-MITIGATED. SEBI enforcement engaged.',
  },
  {
    ...
    social_signal_score: 0.25, misinfo_score: 0.18, threat_type: 'market_manipulation',
    estimated_gain: 14200000,
    severity: 'medium', recommended_action: 'flag_accounts_for_investigation',
    mitigation_status: 'pending', auto_mitigated: false, escalated_to_sebi: false,
    mitigation_notes: 'Score 7.20/10. Under review by compliance team.',
  },
]
...
export const mockHealth = {
  ...
  models: {
    ...
    mitigation_engine: { loaded: true },
    misinfo_model: { loaded: true },
  },
}

export const mockMitigationSummary = {
  total_alerts: 15,
  pending_mitigation: 6,
  applied: 4,
  dismissed: 3,
  escalated: 2,
  auto_mitigated: 1,
  escalated_to_sebi: 3,
  by_severity: { low: 4, medium: 6, high: 4, critical: 1 },
  by_action: {
    freeze_accounts_pending_review: 4,
    flag_accounts_for_investigation: 5,
    freeze_accounts_and_escalate_sebi: 2,
    monitor_and_log: 2,
    block_social_signals_and_alert_compliance: 1,
    flag_entity_for_review: 1,
  },
}

export const mockPendingMitigations = mockAlerts.filter(
  a => a.mitigation_status === 'pending'
)
